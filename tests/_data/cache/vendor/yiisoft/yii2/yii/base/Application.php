	...
	public function handleError($code, $message, $file, $line)
	{
		if (error_reporting() !== 0) {
			...
			if (!class_exists('\\yii\\base\\Exception', false)) {
				require_once \Go\Instrument\Transformer\FilterInjectorTransformer::rewrite((__DIR__ . '/Exception.php'), __DIR__);
			}
			if (!class_exists('\\yii\\base\\ErrorException', false)) {
				require_once \Go\Instrument\Transformer\FilterInjectorTransformer::rewrite((__DIR__ . '/ErrorException.php'), __DIR__);
			}
