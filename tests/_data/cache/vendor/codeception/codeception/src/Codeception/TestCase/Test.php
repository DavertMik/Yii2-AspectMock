...
class Test extends \Codeception\TestCase
{
    ...
    {
        if ($this->bootstrap) require \Go\Instrument\Transformer\FilterInjectorTransformer::rewrite( $this->bootstrap, '/home/davert/demos/yii2/apps/advanced/vendor/codeception/codeception/src/Codeception/TestCase');
